...
FUNCTION landTimeToLong {
	...
	LOCAL TgtLong IS utilReduceTo360(lng).
	LOCAL ShipLong is utilReduceTo360(SHIP:LONGITUDE).
...
// NB: _very_ similar to node_alt, except for:
// - v1 there is velocity at node time
// - r2 there is br + ship's altitude at the node time
// - sma2 there is (alt + br + r2)/2
